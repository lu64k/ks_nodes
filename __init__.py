...
NODE_CLASS_MAPPINGS = {
    ...
    "KS json key replace": KS_Json_Key_Replace_3ways,
    "KS json value eliminator": KS_Json_Value_Eliminator,
    "KS json extract key and value": KS_Json_Extract_Key_And_Value_3ways,
    "KS json key random": KS_Json_Key_Random_3ways,
    "KS Json Count": KS_Json_Count,
    #"KS Word Frequency Statistics": KS_Word_Frequency_Statistics,
    "KS Load Images From Folder KS": KS_Load_Images_From_Folder,
    "KS Json To String": KS_JsonToString,
    "KS JsonlReader":KS_Json_loader,
